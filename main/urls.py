...
from main.views import show_create_product, show_login, show_logout, show_main, show_product, show_products, show_products_xml, show_products_json, show_product_xml_by_id, show_product_json_by_id, show_register
